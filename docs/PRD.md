...
- Koneksi Vercel ke database belum terenkripsi dan akun database aplikasi masih terlalu luas haknya (temuan audit 24 September 2026). Rencana: aktifkan TLS di Postgres atau PgBouncer TLS, akun database khusus aplikasi dengan hak minimum, lalu ganti kata sandi database.
