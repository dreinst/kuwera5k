...
- Hero: sub judul jadi "Fun run 5K di Malang, Jawa Timur. Diselenggarakan oleh Keuangan Angkatan Darat Malang." Baris "Diselenggarakan oleh" + logo D'Pro diganti hitung mundur ke start (hari, jam, menit, detik; jam dibaca dari browser). Logo D'Pro tetap di footer.
- Section baru Jadwal lomba (setelah pita tanggal, meniru "Race Schedule" malangrun10k.com): periode pendaftaran, pengambilan race pack, hari lomba, lalu tombol Daftar sekarang.
