...
- Hero: baris "Diselenggarakan oleh" + logo D'Pro diganti hitung mundur ke start (hari, jam, menit, detik; jam dibaca dari browser). Logo D'Pro tetap di footer. Revisi 25 Sep: hitung mundur sebaris dengan judul KUWERA FUN RUN 5K di layar lebar (di HP turun ke bawah judul), sub judul jadi "Fun run 5K yang diselenggarakan oleh Keuangan Angkatan Darat Malang, dengan start dan finish di Lapangan Rampal."
