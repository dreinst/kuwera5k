...
- Temuan: loop jalan raya menurut OSM hanya sekitar 4,0 km (KM 1 Panglima Sudirman, KM 2 Kesatrian, KM 3 Hamid Rusdi Timur, finish 3,98 km), padahal event dibrand 5K. Kemungkinan sisanya putaran di dalam/mengelilingi Lapangan Rampal (peta panitia menggambar dua garis sejajar di selatan lapangan). Skrip punya opsi `FIELD_LAP=1` untuk menambah putaran sisi timur dan selatan lapangan, dimatikan sampai panitia mengonfirmasi jalur di kawasan Rampal atau memberi file GPX.
