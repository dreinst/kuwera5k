...
- [x] kota Malang, tanggal/lokasi dummy
- [x] kategori/harga dummy, final menyusul
- [ ] merchant Midtrans: badan usaha ada, konfirmasi ulang dokumen
...
- [ ] domain belum (placeholder kuwera5k.id, putuskan minggu 1 karena menentukan email)
- [x] hosting VPS panitia
